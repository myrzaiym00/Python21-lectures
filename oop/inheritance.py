"Наследовние - принцип ООП, где мы можем в дочернем классе унаследовать, переопределять и использовать все атрибуты и методы родительского класс"
...
class B(A):
    """Мы наследовали все методы и атрибуты у класса А"""
...
class C(A):
    """Наследовали все атрибуты и методы у класса А и переопределили метод method"""

    def method(self):
        print("Mrthod in class C")
