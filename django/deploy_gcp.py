...
"git clone https_or_ssh_link project" # во всех последующих примерах вместо project пишите название вашей папки с проектом

# зайдите в папку, создайте витруальное окружение, установите все библеотеки (включая gunicorn), создайте .env и запишите в него нужные данные
"""
cd project/
python3 -m venv venv
. venv/bin/activate
pip install -r requirements.txt
pip install gunicorn (если нет в requirements.txt)
touch .env
nano .env
"""
...
# не забудьте в ALLOWED_HOSTS добавить External IP своей вм (можно посмотреть https://console.cloud.google.com/compute/instances)
